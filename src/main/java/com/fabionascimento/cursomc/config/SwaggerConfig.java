package com.fabionascimento.cursomc.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.fabionascimento.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				new Contact("Fabio Nascimento", "https://github.com/fabiosnascimento/spring-boot-ionic-backend", "fabiogtr@hotmail.com"),
